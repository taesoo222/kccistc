...
module datapath (
    ...
    logic [31:0] dec2exe_rs1, dec2exe_rs2, dec2exe_imm, exe2mem_alu, exe2mem_rs2, mem2wb_rdata;
    logic        b_taken;
...
module alu (
    ...
    always_comb begin
        ...
        case (alu_control)
            ...
            4'b0_010: alu_result = ($signed(rs1) < $signed(rs2)) ? 32'd1 : 32'd0; //slt
...
(
    ...
    always_comb begin
        case (opcode)
        OP_STYPE: imm_extend = {{20{instr_code[31]}},{instr_code[31:25], instr_code[11:7]}};
        OP_ITYPE, OP_ILTYPE, OP_JLTYPE: imm_extend = {{20{instr_code[31]}},instr_code[31:20]};
        OP_BTYPE: imm_extend = {{20{instr_code[31]}},instr_code[7],instr_code[30:25],instr_code[11:8],1'b0};
